...
import { getWorkoutDetail, updateWorkout } from '@/services/workouts';
import styles from './EditWorkoutScreen.styles';
...
const EditWorkoutScreen = () => {
  ...
  const handleSaveWorkout = async () => {
    await updateWorkout(uid, id as string, { name: workoutTitle, exercises: exerciseList });
